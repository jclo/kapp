 ...
 * Starts processes(s).
 *
 * process.js is just a literal object that contains a set of functions.
...
const config = require('../config')
    , C      = require('../_custom/process/main')
    ;


// -- Local Constants
const { level } = config
    , log       = KZlog('core/processes.js', level, false)
    ;
