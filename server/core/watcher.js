 ...
 *
 * watch.js is just a literal object that contains a set of functions.
...
const config = require('../config')
    , CusW   = require('../_custom/dbwatcher/main')
    ;


// -- Local Constants
const { level } = config
    , log       = KZlog('core/watcher.js', level, false)
    ;
...
const Watcher = {
  ...
  start(app, i18n, dbi, dbn, dbm) {
    ...
    CusW.start(app, i18n, dbi, dbn, dbm);
    return this;
  },
};
